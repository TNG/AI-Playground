...
if (
  ...
  console.error(
    'Usage: node provide-electron-build-resources.js --build_resources_dir=$DIR --python_env_dir=$DIR --backend_dir=$DIR --llamacpp_dir=$DIR --openvino_dir=$DIR --shared_dir=$DIR --device_service_dir=$DIR --target_dir=$DIR\n',
  )
  process.exit(1)
}
