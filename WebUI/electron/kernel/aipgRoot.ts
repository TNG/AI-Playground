...
/**
 * The shipped `external/` tree (models.json, presets, backend versions). In a
 * packaged app it is the resources root; unpackaged it is resolved against the
 * bundle output directory, not this source file.
 */
