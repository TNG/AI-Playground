 ...
 */
const WARMUP_MAX_CONSECUTIVE_FAILURES = 3
...
/**
 * Separator deriveGroupContent joins a group's chunks with. Its token cost is charged
 * against MAX_TOKENS_PER_GROUP during grouping, since it ends up in the text that is
