...
import type { ApiService } from '../../../adapters/backends/service'
...
vi.mock('../../../adapters/install/processLifecycle', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../../../adapters/install/processLifecycle')>()),
