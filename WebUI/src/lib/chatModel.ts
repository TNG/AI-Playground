...
// src/lib/toolAgent.ts) run against the exact same endpoint and
 ...
 * media specialist and other renderer-side AI SDK callers keep using
 * `createChatModel()` directly until they move (step 6 item 9).
 */
